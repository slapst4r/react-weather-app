...
const WeatherComp = (props) => {
  ...
  console.log(props)
  return (
    <div className="font-semibold p-6 space-y-3 relative mx-auto my-5 rounded text-xl bg-white text-gray-600 shadow-xl py-5 min-w-max">
      ...
      {/* <img src={`http://openweathermap.org/img/wn/${props?.weatherData.weather[0]?.icon}@2x.png`} alt={props?.weather?.name}></img> */}
       <img 
        className='mx-auto'
